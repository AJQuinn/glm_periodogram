...
glm.viz.plot_design_summary(X1, regressor_names1, contrasts=C1, contrast_names=contrast_names1, ax=ax)
...
glm.viz.plot_design_summary(X2, regressor_names2, contrasts=C2, contrast_names=contrast_names2, ax=ax)
